            ...
            or there's an error (n == -1)
             or the client closed the socket (n == 0) */
                ...
                else /* n > 0 */
                {
                    ...
                    char buf4[BUFFER_SIZE] = {0};
                    char buf5[BUFFER_SIZE] = {0};
                    ...
                    strftime(buf, BUFFER_SIZE, "%A, ", ptm);
                    
                    strftime(buf1, BUFFER_SIZE, "%B ", ptm);
                    
                    strftime(buf2, BUFFER_SIZE, "%-d, ", ptm);
                    
                    strftime(buf3, BUFFER_SIZE, "%G ", ptm);
                    
                    strftime(buf4, BUFFER_SIZE, "%T", ptm);
                    
                    
                    strftime(buf5, BUFFER_SIZE, "-%Z", ptm);
